...
std::shared_ptr<Texture2D> Texture2D::CreateEmpty(DXGI_FORMAT format, unsigned int width, unsigned int height, CreationFlags creationFlags)
{
...
std::shared_ptr<Texture2D> Texture2D::CreateEmpty(DXGI_FORMAT format, unsigned int width, unsigned int height, DXGI_SAMPLE_DESC& samplingSettings, CreationFlags creationFlags)
{
	return CreateEx(nullptr, format, width, height, samplingSettings, creationFlags);
}

std::shared_ptr<Texture2D> Texture2D::CreateFromData(const void* data, DXGI_FORMAT format, unsigned int width, unsigned int height, CreationFlags creationFlags)
{
	DXGI_SAMPLE_DESC samplingSettings;
	samplingSettings.Count = 1;
	samplingSettings.Quality = 0;
...
std::shared_ptr<Texture2D> Texture2D::CreateEx(const void* data, DXGI_FORMAT format, unsigned int width, unsigned int height, DXGI_SAMPLE_DESC& samplingSettings, CreationFlags creationFlags)
{
